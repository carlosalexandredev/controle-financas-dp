package com.example.demo.fortune.util.cotacao.factory;


import com.example.demo.fortune.util.cotacao.template_method.CotacaoAPI;
import com.example.demo.fortune.util.cotacao.template_method.CotacaoDolar;
import com.example.demo.fortune.util.cotacao.template_method.CotacaoEuro;
